...
(function (Odrl) {
  ...
  const Constraint = (function () {
    ...
    Constraint.prototype.serializeXml = function (serStrIn) {
      let serStrOut = `${serStrIn}<constraint leftOperand="${this.leftOperand}"`;
  ...
  const Party = (function () {
    ...
    Party.prototype.serializeXml = function (serStrIn) {
      let serStrOut = `${serStrIn}<party uid="${this.uid}"`;
  ...
  const Failure = (function () {
    ...
    Failure.prototype.addAsset = function (uid, relation) {
      const newAsset = new Asset(uid, relation);
    ...
    Failure.prototype.addParty = function (uid, pfunction, scope) {
      const newParty = new Party(uid, pfunction, scope);
  ...
  const Duty = (function () {
    ...
    Duty.prototype.addConstraint = function (leftOperand, operator, rightOperand, dataType, unit, status) {
      const newConstraint = new Constraint(leftOperand, operator, rightOperand, dataType, unit, status);
    ...
    Duty.prototype.serializeXml = function (serStrIn) {
      ...
      for (i = 0; i < this.consequences.length; i++) {
        const s1 = this.consequences[i].serializeXml(serStrOut);
        const s2 = s1.replace('<failure>', '<consequence>');
  ...
  const Permission = (function () {
    ...
    Permission.prototype.addTargetAsset = function (uid) {
      const newAsset = new Asset(uid, Odrl.AssetRelationsCV.target);
      this.assets.push(newAsset);
      return this;
    };
    ...
    Permission.prototype.addConstraint = function (name, operator, rightOperand, dataType, unit, status) {
      const newConstraint = new Constraint(name, operator, rightOperand, dataType, unit, status);
      this.constraints.push(newConstraint);
      return this;
    };
    ...
    Permission.prototype.serializeXml = function (serStrIn) {
      let serStrOut = `${serStrIn}<permission>`;
      let i;
      for (i = 0; i < this.assets.length; i++) {
        serStrOut = this.assets[i].serializeXml(serStrOut);
      }
  ...
  const Prohibition = (function () {
    ...
    Prohibition.prototype.serializeXml = function (serStrIn) {
      let serStrOut = `${serStrIn}<prohibition>`;
      let i;
      for (i = 0; i < this.assets.length; i++) {
        serStrOut = this.assets[i].serializeXml(serStrOut);
      }
  ...
  const Policy = (function () {
    ...
    Policy.prototype.serializeXml = function () {
      let serStr = `<Policy uid="${this.uid}" type="${this.type}"`;
