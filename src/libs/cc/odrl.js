import { ID_BY_ND, ID_BY_SA, ID_BY_NC, ID_BY_NC_ND, ID_BY_NC_SA } from './identifiers';
import { URI_REPRODUCTION, URI_DISTRIBUTION, URI_DERIVATIVE_WORKS, URI_NOTICE, URI_ATTRIBUTION, URI_SHARE_ALIKE, URI_COMMERCIAL_USE } from './uris'
