...
<div style="font-family: 'Helvetica';">
    ...
    <div class="rule">
        ...
        <div class="button-group">
            <button class="positive" v-bind:class="{active: reproduction}" v-on:click="reproduction = true">Erlaubt</button>
            <button class="negative" v-bind:class="{active: !reproduction}" v-on:click="reproduction = false;">Nicht erlaubt</button>
        </div>
    </div>
    <div class="rule">
        ...
        <div class="button-group">
            <button class="positive" v-bind:class="{active: distribution}" v-on:click="distribution = true">Erlaubt</button>
            <button class="negative" v-bind:class="{active: !distribution}" v-on:click="distribution = false;">Nicht erlaubt</button>
        </div>
    </div>
    <div class="rule">
        ...
        <div class="button-group">
            <button class="positive" v-bind:class="{active: derivateWorks}" v-on:click="derivateWorks = true">Erlaubt</button>
            <button class="negative" v-bind:class="{active: !derivateWorks}" v-on:click="derivateWorks = false;">Nicht erlaubt</button>
        </div>
    </div>
    <div class="rule">
        ...
        <div class="button-group">
            <button class="positive" v-bind:class="{active: sharing}" v-on:click="sharing = true">Erlaubt</button>
            <button class="negative" v-bind:class="{active: !sharing}" v-on:click="sharing = false;">Nicht erlaubt</button>
        </div>
    </div>
    ...
    <div class="rule">
        ...
        <div class="button-group">
            <button class="positive" v-bind:class="{active: nonCommercialUse}" v-on:click="nonCommercialUse = true">Eingeschränkt</button>
            <button class="negative" v-bind:class="{active: !nonCommercialUse}" v-on:click="nonCommercialUse = false;">Nicht Eingeschränkt</button>
        </div>
    </div>
    <h2>Anforderung</h2>
    <div class="rule">
        ...
        <div class="button-group">
            <button class="positive" v-bind:class="{active: notice}" v-on:click="notice = true">Verlangt</button>
            <button class="negative" v-bind:class="{active: !notice}" v-on:click="notice = false;">Nicht verlangt</button>
        </div>
    </div>
    <div class="rule">
        ...
        <div class="button-group">
            <button class="positive" v-bind:class="{active: shareAlike}" v-on:click="shareAlike = true">Verlangt</button>
